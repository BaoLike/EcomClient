...
const ProductManagement: React.FC = () => {
  ...
  const handleUpdateProduct = async (formData: any) => {
    try {
      const sizeIds = formData.sizeIds || [];
      const updatedProduct = await apiService.updateProductWithSizes(
      ...
      setProducts(products.map(p => 
        p.productId === selectedProduct.productId 
          ? { ...p, ...formData, sizes: updatedProduct.sizes } 
          : p
      ));
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-gray-600">Quản lý kho hàng và danh mục sản phẩm</p>
          </div>
          <Link
            to="add"
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900">Kho: {product.quantity}</p>
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 text-sm mt-1">
                {searchTerm ? 'Thử điều chỉnh từ khóa tìm kiếm' : 'Bắt đầu bằng cách thêm sản phẩm đầu tiên'}
              </p>
              {!searchTerm && (
                <Link
                  to="/products/add"
